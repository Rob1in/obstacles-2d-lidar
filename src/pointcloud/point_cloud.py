...
class PointCloud():
    ...
    def project(self, normal_vector:np.array):
        ...
        projection = self.points - np.outer(np.dot(self.points, normal_vector), normal_vector)
